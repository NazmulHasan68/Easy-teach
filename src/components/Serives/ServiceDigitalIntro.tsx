...
import marketingImg from "@/assets/img/seo.jpg"; // use a marketing related image
      ...
      <div className="relative max-w-7xl mx-auto px-6 gap-24 items-center">
        ...
        >
          <img
            ...
            className="rounded-3xl shadow-2xl w-full h-[320px] object-cover"
          />

          {/* Experience badge */}
          <div className="absolute -bottom-8 right-2 bg-white shadow-2xl rounded-2xl px-8 py-6 ">
        ...
        >
          ...
          <p className="text-gray-600 leading-relaxed mb-10 text-lg">
            At EasyTech Solutions, we help brands grow faster through data-driven
            digital marketing strategies. From SEO and social media campaigns to
            paid ads and content marketing, we create visibility that converts
