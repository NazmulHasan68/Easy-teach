...
export default function ClientHero() {
  return (
    <section
      className="relative h-[60vh] md:h-[70vh] flex items-center justify-center bg-center bg-cover"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl">
        <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold text-white leading-tight">
          Meet With Our<br></br> <span className="text-green-500">Happy Clients</span>
        </h1>
