...
export default function HomePricing() {
  ...
  return (
    ...
    >
      ...
      <div aria-hidden className="absolute inset-0 bg-gradient-to-b from-[#f6fbf6] via-white to-[#eef5ee]" />
      <div aria-hidden className="absolute -top-32 -left-32 w-[420px] h-[420px] bg-[#98BC62]/20 blur-[140px] rounded-full" />
      <div aria-hidden className="absolute bottom-0 -right-32 w-[420px] h-[420px] bg-[#2D602E]/20 blur-[140px] rounded-full" />
          ...
          <AnimatePresence mode="wait">
            <motion.div key={index} className="grid grid-cols-1 md:grid-cols-2">
              ...
              <motion.div
                ...
                animate="animate"
                exit="exit"
                className="relative h-[260px] sm:h-[340px] md:h-[520px] overflow-hidden"
              ...
              >
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#2D602E]/70 via-transparent to-transparent" />
              </motion.div>
              ...
              >
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-[#2D602E] to-[#98BC62] text-white px-6 sm:px-8 py-3 rounded-full w-fit shadow-lg hover:scale-105 transition duration-300 text-sm sm:text-base"
                >
                  Explore More →
                </button>
