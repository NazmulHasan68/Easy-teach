  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#f9fdf7] via-[#eef6ee] to-[#e9f3e9]" />
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
            {items.map((item, i) => (
              ...
              >
                ...
                <div className="absolute inset-0 rounded-3xl p-[1px] bg-gradient-to-br from-[#2D602E] to-[#98BC62] opacity-0 group-hover:opacity-100 transition duration-500" />
                ...
                <div className="relative rounded-3xl bg-white/85 backdrop-blur-xl border border-white/40 shadow-[0_35px_90px_rgba(45,96,46,0.15)] overflow-hidden transition-all duration-500">
                  ...
                  <div className="relative h-44 md:h-52 overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[#2D602E]/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition duration-500" />
